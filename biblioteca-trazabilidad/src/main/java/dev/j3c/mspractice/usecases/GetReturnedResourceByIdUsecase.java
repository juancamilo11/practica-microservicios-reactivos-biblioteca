...
@Service
@Validated
public class GetReturnedResourceByIdUsecase implements GetApprovedSaleById {
    ...
    @Autowired
    public GetReturnedResourceByIdUsecase(ResourceLoaningRepository resourceLoaningRepository, ResourceLoaningMapper resourceLoaningMapper) {
