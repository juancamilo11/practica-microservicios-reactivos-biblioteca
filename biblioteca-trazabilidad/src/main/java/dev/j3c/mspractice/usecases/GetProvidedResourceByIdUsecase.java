...
@Service
@Validated
public class GetProvidedResourceByIdUsecase implements GetApprovedSaleById {
    ...
    @Autowired
    public GetProvidedResourceByIdUsecase(ResourceLoaningRepository resourceLoaningRepository, ResourceLoaningMapper resourceLoaningMapper) {
