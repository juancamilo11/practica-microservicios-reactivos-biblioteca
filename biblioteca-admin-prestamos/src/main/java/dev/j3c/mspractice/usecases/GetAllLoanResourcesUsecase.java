...
import dev.j3c.mspractice.usecases.interfaces.GetAllLoanResources;
...
@Service
@Validated
public class GetAllLoanResourcesUsecase implements GetAllLoanResources {
    ...
    @Autowired
    public GetAllLoanResourcesUsecase(ResourceLoaningRepository resourceLoaningRepository, ResourceLoaningMapper resourceLoaningMapper) {
